        ...
        <div className="relative z-10 w-full h-full">
          <div 
            className={`absolute 
              ...
              left-[60%] sm:left-[60%] md:left-[55%] lg:left-[50%] xl:left-[691px] 
              -translate-x-1/2 xl:translate-x-0 
              -translate-y-1/2 xl:translate-y-0 
              w-[245px] sm:w-[350px] md:w-[400px] lg:w-[450px] xl:w-[576px] 
              min-h-[246.27px] sm:h-[180px] md:h-[160px] lg:h-[140px] xl:h-[112px] 
          ...
          >
            <h1 className="font-bold text-[22px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] leading-[28px] sm:leading-[32px] md:leading-[34px] lg:leading-[36px] xl:leading-[38px] text-center text-[#22272A] xl:text-white max-w-[280px] mx-auto sm:max-w-none">
              In Every Movie, There's Magic
            </h1>
            <p className="font-['Poppins'] font-normal text-[13px] sm:text-[14.5px] md:text-[15px] lg:text-[15.5px] xl:text-[16px] leading-[16px] sm:leading-[16.5px] md:leading-[17px] lg:leading-[17.5px] xl:leading-[18px] text-center text-[#797979] xl:text-[#FCF7F3] max-w-[280px] mx-auto sm:max-w-none">
